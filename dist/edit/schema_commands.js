...
_model.Paragraph.register("textblockMenu", "main", { label: "Normal", rank: 10 });

_model.CodeBlock.register("textblockMenu", "main", { label: "Code", rank: 20 });

var _loop2 = function _loop2(i) {
  _model.Heading.registerComputed("textblockMenu", String(i), function (type) {
...
_model.Image.register("insertMenu", "main", { label: "Image", command: "insert", rank: 20 });

_model.HorizontalRule.register("insertMenu", "main", { label: "Horizontal rule", command: "insert", rank: 70 });